							...
							<div class="contact-form">
								<form wire:submit="submit">
									<div class="form-group mb-4 pb-2">
										...
										<input wire:mode="name" type="text" class="form-control shadow-none @error('name') is-invalid @enderror" id="name">
                                        @error('name')
									...
									<div class="form-group mb-4 pb-2">
                                        ...
                                        <input wire:mode="email" type="email" class="form-control shadow-none @error('email') is-invalid @enderror" id="email">
                                        @error('email')
                                            <p class="invalid-feedback">{{ $message}}</p>
                                        @enderror
									</div>
									<div class="form-group mb-4 pb-2">
										...
										<textarea wire:mode="message" class="form-control shadow-none" id="message" rows="3"></textarea>
									</div>
